...
//VRMonkey begin
IConsoleVariable* FStereoPanoramaManager::CombineAtlasesOnOutput = IConsoleManager::Get().RegisterConsoleVariable(TEXT("SP.CombineAtlasesOnOutput"), false, TEXT("Combine the stereo images in one image file?"), ECVF_Default);
IConsoleVariable* FStereoPanoramaManager::stereo = IConsoleManager::Get().RegisterConsoleVariable(TEXT("SP.Stereo"), false, TEXT("Mono 0 and Stereo 1"), ECVF_Default);

//IConsoleVariable* FStereoPanoramaManager::OutPutFileExtension = IConsoleManager::Get().RegisterConsoleVariable(TEXT("SP.OutPutFileExtension"), TEXT(".JPG"), TEXT("Output File Extension"), ECVF_Default);
//VRMonkey END
